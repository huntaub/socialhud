...
- (MLReference *)OLDMessageEditors {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference elements: 'medt']];
}
...
- (MLReference *)_0x28OLD0x29ComposeMessage_ {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'bcke']];
}
...
- (MLReference *)fileSize {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'atsz']];
}
...
- (MLReference *)hostsToLogActivityOn {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'laoh']];
}

- (MLReference *)htmlContent {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'htda']];
}
...
- (MLReference *)logAllSocketActivity {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'laas']];
}

- (MLReference *)logMessages {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'mllg']];
}
...
- (MLReference *)memoryStatistics {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'mems']];
}
...
- (MLReference *)messages {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'mvms']];
}
...
- (MLReference *)portsToLogActivityOn {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'laop']];
}
...
- (MLReference *)useKeychain {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'uske']];
}
...
- (MLReference *)vcardPath {
    return [MLReference referenceWithAppData: AS_appData
                    aemReference: [AS_aemReference property: 'htvc']];
}
