...
+ (id)constantWithCode:(OSType)code_ {
    switch (code_) {
        ...
        case 'etit': return [self MobileMe];
        case 'itac': return [self MobileMeAccount];
        case 'mon ': return [self Monday];
        case 'nov ': return [self November];
        case 'medt': return [self OLDMessageEditor];
        ...
        case 'atsz': return [self fileSize];
        ...
        case 'laoh': return [self hostsToLogActivityOn];
        case 'htda': return [self htmlContent];
        ...
        case 'laas': return [self logAllSocketActivity];
        case 'mllg': return [self logMessages];
        ...
        case 'mems': return [self memoryStatistics];
        ...
        case 'mvms': return [self messages];
        ...
        case 'laop': return [self portsToLogActivityOn];
...
+ (MLConstant *)MobileMe {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"MobileMe" type: typeEnumerated code: 'etit'];
    return constantObj;
}
...
+ (MLConstant *)none {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"none" type: typeEnumerated code: 'ccno'];
    return constantObj;
}
...
+ (MLConstant *)MobileMeAccount {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"MobileMeAccount" type: typeType code: 'itac'];
    return constantObj;
}
...
+ (MLConstant *)OLDMessageEditor {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"OLDMessageEditor" type: typeType code: 'medt'];
    return constantObj;
}
...
+ (MLConstant *)_0x28OLD0x29ComposeMessage_ {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"_0x28OLD0x29ComposeMessage_" type: typeType code: 'bcke'];
    return constantObj;
}
...
+ (MLConstant *)fileSize {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"fileSize" type: typeType code: 'atsz'];
    return constantObj;
}
...
+ (MLConstant *)hostsToLogActivityOn {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"hostsToLogActivityOn" type: typeType code: 'laoh'];
    return constantObj;
}

+ (MLConstant *)htmlContent {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"htmlContent" type: typeType code: 'htda'];
    return constantObj;
}
...
+ (MLConstant *)logAllSocketActivity {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"logAllSocketActivity" type: typeType code: 'laas'];
    return constantObj;
}

+ (MLConstant *)logMessages {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"logMessages" type: typeType code: 'mllg'];
    return constantObj;
}
...
+ (MLConstant *)memoryStatistics {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"memoryStatistics" type: typeType code: 'mems'];
    return constantObj;
}
...
+ (MLConstant *)messages {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"messages" type: typeType code: 'mvms'];
    return constantObj;
}
...
+ (MLConstant *)portsToLogActivityOn {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"portsToLogActivityOn" type: typeType code: 'laop'];
    return constantObj;
}
...
+ (MLConstant *)useKeychain {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"useKeychain" type: typeType code: 'uske'];
    return constantObj;
}
...
+ (MLConstant *)vcardPath {
    static MLConstant *constantObj;
    if (!constantObj)
        constantObj = [MLConstant constantWithName: @"vcardPath" type: typeType code: 'htvc'];
    return constantObj;
}
