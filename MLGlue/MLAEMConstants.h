...
enum {
    ...
    kMLMarch = 'mar ',
    kMLMay = 'may ',
    kMLMobileMeAccount = 'itac',
    kMLMonday = 'mon ',
    kMLNovember = 'nov ',
    kMLOLDMessageEditor = 'medt',
    kMLOctober = 'oct ',
    kMLPICTPicture = 'PICT',
    kMLRGB16Color = 'tr16',
    kMLRGB96Color = 'tr96',
    ...
    kMLTuesday = 'tue ',
    kMLWednesday = 'wed ',
    kML_0x28OLD0x29ComposeMessage_ = 'bcke',
    kMLAccount = 'mact',
...
enum {
    eMLMacAccounts = 'itac',
    eMLMobileMeAccounts = 'itac',
    eMLOLDMessageEditors = 'medt',
    eMLAccounts = 'mact',
    ...
    eMLWords = 'cwor',
    pMLMIMEType = 'attp',
    pML_0x28OLD0x29ComposeMessage_ = 'bcke',
    pMLAccount = 'mact',
    ...
    pMLLogAllSocketActivity = 'laas',
    pMLLogMessages = 'mllg',
    pMLMailbox = 'mbxp',
    pMLMailboxListVisible = 'mlsh',
    pMLMarkFlagged = 'rmfl',
    pMLMarkRead = 'rmre',
    pMLMemoryStatistics = 'mems',
