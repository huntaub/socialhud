...
- (NSString *)propertyByCode:(OSType)code {
    switch (code) {
        ...
        case 'bcke': return @"_0x28OLD0x29ComposeMessage_";
        ...
        case 'laoh': return @"hostsToLogActivityOn";
        case 'htda': return @"htmlContent";
        case 'ID  ': return @"id_";
        ...
        case 'laop': return @"portsToLogActivityOn";
        ...
        case 'uske': return @"useKeychain";
        case 'unme': return @"userName";
        case 'usss': return @"usesSsl";
        case 'htvc': return @"vcardPath";
...
- (NSString *)elementByCode:(OSType)code {
    switch (code) {
        case 'itac': return @"MobileMeAccounts";
        case 'medt': return @"OLDMessageEditors";
